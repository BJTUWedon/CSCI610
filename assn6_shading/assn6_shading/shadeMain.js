...
function setUpPhong(program) {
    ...
    gl.uniform3fv(program.ambientLight, glMatrix.vec3.fromValues(1, 0, 1))
    gl.uniform3fv(program.lightPosition, glMatrix.vec3.fromValues(1, 0, 0))
    gl.uniform3fv(program.lightColor, glMatrix.vec3.fromValues(1, 1, 1))
    gl.uniform3fv(program.baseColor, glMatrix.vec3.fromValues(1, 0, 0))
...
function setUpCamera(program) {
    ...
    glMatrix.mat4.frustum(projMatrix, -2, 2, -2, 2, 3, 300);
    gl.uniformMatrix4fv (program.uProjT, false, projMatrix);

    // set up your view
    let viewMatrix = glMatrix.mat4.create();
    glMatrix.mat4.lookAt(viewMatrix, [0, 1, -3], [0, 0, 0], [0, 1, 0]);
